...
<head>
    ...
    <script type="text/javascript">
                        ...
                        */
                        ...
                        /*
                           <select id="create-marketActivityOwner">
                              <option value="06f5fc056eac41558a964f96daa7f27c">科比</option>
                              <option value="40f6cdea0bd34aceb77492a1656d9fb3">欧文</option>
                           </select>
                            ...
                            */
                            ...
                            /*
                               注意：
                                  ...
                                  但是表单的jquery对象，没有为他们提供reset()方法让我们重置表单
                                  （坑：idea为我们提示有reset()方法）

                                  虽然jqeury对象没有为我们提供reset方法，但是原生js为我们提供了reset方法
            ...
            $("#deleteBtn").click(function () {
                ...
                if ($xz.length == 0) {
                    ...
                    if(confirm("确定删除所选中的记录吗？")) {
                        ...
                        // url: workbench/activity/delete?id=xxx&id=xxx&id=xxx
        ...
        /*
           ...
           （1）点击左侧菜单中的"市场活动"超链接，需要刷新市场活动信息列表，需要调用pageList方法
           （2）添加、修改、删除后，需要刷新市场活动信息列表，需要调用pageList方法
           （3）点击查询按钮的时候，需要刷新市场活动信息列表，需要调用pageList方法
           （4）点击分页组件的时候，需要刷新市场活动信息列表，需要调用pageList方法

           以上为pageList方法制定了六个入口，也就是说，在以上6个操作执行完毕后，我们必须
           要调用pageList方法，刷新市场活动信息列表
         */
        function pageList(pageNum, pageSize) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    /*
                      我们需要的：市场活动信息列表
                      data [{市场活动1},{2},{3}]  List<Activity> aList
                      一会分页插件需要的：查询出来的总记录数
                      {"total":20} int total
    ...
    <div class="modal-dialog" role="document" style="width: 85%;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="moidal">
